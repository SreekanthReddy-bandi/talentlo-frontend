      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="lg:w-1/2">
          <div className="border rounded p-6">
            ...
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-6">
              Apply as a Freelancer
            </button>
            <p className="mt-4 text-center text-gray-600">Already have an account? <a href="#" className="text-blue-600">Log in</a></p>
          </div>
        </div>
      </div>
